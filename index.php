...
<?php
	...
	window.history.replaceState(null, null, 'https://tunnal.ink/');
		...
		if (mysqli_num_rows($result) == 1) {
			...
			$url = $row['next_url'];
          	echo "<h1 id='wait'>Đợi chút xíu tầm <span id='sec'>6</span> giây thôi bạn nhé!!!<br>┗(^o^　)┓三</h1>";
          	echo "Đang chuyển hướng đến đường dẫn được chia sẻ... // Redirecting to content, please wait a second...<br><br>
            
            	<a href='tel:+84376953283' style='max-width: 100vw;max-height: 600px;width: 100%;height: 100%;zoom: 0.7'>
					<img class='ads' src='./ads_for_lease.jpg'>            
            	</a>
                <p>--------- Được tài trợ bởi: tunnaAds ----------</p>
...
<script>
  ...
  var timer = setInterval(function() {
    ...
    if (temp <= 0) {
      ...
      document.getElementById("wait").innerHTML = "Xong ròiii, đợi lâu lắm hong :v? Gét gô... <br> ᕕ(︶‿︶)ᕗ";
    }
  }, COUNTDOWN_DELAY);
